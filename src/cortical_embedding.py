...
from src.paths import (
    ...
    COG_NETWORK_OVERLAP,
    DISTANCE_MATRIX_PATH_MOUSE,
    CORTICAL_AREAS_PATH_MOUSE,
)
...
class MouseCorticalEmbedding(CorticalEmbedding):
    def __init__(
        self,
        duplicates,
        constraints,
        ...
        distance_matrix_path = DISTANCE_MATRIX_PATH_MOUSE
        cortical_areas_path = CORTICAL_AREAS_PATH_MOUSE
        super().__init__(
            duplicates,
            constraints,
            distance_matrix_path,
